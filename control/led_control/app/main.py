...
state_rules = {"Off":transition_rule("0","Off","HumidOn",15*60),"HumidOn":transition_rule("1","HumidOn","Humidify",15),
               "Humidify":transition_rule("2","Humidify","FanOff",1.5*60),"FanOff":transition_rule("3","FanOff","Off",15),
